...
import com.project.financialManagement.databinding.FragmentAddIncomeBinding
 ...
 * Use the [AddIncome.newInstance] factory method to
...
class AddIncome : Fragment() {
    ...
    override fun onCreateView(
        ...
        // dropdown label
        val labelMenu = DropdownMenu(requireContext(), listOf("Lương", "Thưởng", "Quà")) { selectedItem, _ ->
        ...
        binding.save.setOnClickListener {
            ...
            if(category.isNullOrEmpty() || time.isNullOrEmpty() || total.isNullOrEmpty() || description.isNullOrEmpty()) {
            ...
            dh.addTransaction(Transaction(newId, TransactionType.INCOME, time, total.toDouble(), category, description))
        }
        return root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment AddIncome.
         */
